...
fun MainScreen( navController: NavController) {
    Scaffold (
        ...
        content = {innerPadding -> Text("Content for Home screen", modifier = Modifier.padding(innerPadding))},
    )
}
...
fun InfoScreen( navController: NavController) {
    Scaffold (
        ...
        content = {innerPadding -> Text("Content for Info screen", modifier = Modifier.padding(innerPadding))},
    )
}
...
fun SettingsScreen( navController: NavController) {
    Scaffold (
        ...
        content = {innerPadding -> Text("Content for Settings screen", modifier = Modifier.padding(innerPadding))},
    )
}
